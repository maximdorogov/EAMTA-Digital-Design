...
HD_PWD='C:/Users/ASUS/Desktop/EAMTA2019/Projects/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftleds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shiftleds.tcl -notrace
