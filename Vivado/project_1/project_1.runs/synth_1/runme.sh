...
HD_PWD='C:/Users/ASUS/Desktop/EAMTA2019/Projects/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftleds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftleds.tcl
