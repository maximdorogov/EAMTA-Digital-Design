...
HD_PWD='C:/Users/ASUS/Desktop/EAMTA2019/Projects/Vivado/Logic_Analizer/Logic_Analizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ila.tcl
