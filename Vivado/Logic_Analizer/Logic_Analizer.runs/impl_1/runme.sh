...
HD_PWD='C:/Users/ASUS/Desktop/EAMTA2019/Projects/Vivado/Logic_Analizer/Logic_Analizer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ila.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ila.tcl -notrace
