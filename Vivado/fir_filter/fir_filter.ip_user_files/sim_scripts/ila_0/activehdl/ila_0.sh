...
#
# Generated by Vivado on Tue Mar 12 09:24:07 -0300 2019
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/ASUS/Desktop/EAMTA2019/Projects/Vivado/fir_filter/fir_filter.cache/compile_simlib/activehdl"
  fi
